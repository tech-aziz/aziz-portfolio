...
export default function TechStack() {
  ...
  const mobileCrossPlatform: TechItem[] = [
    {
      name: "Flutter",
      color: "#02569B",
      customIcon: (
  ...
  const backendIntegrations: TechItem[] = [
