...
export const PROJECTS_LIST: ProjectCardData[] = [
  ...
  },
  {
    ...
    outcome: "Deployed successfully and used by over 5,000 corporate employees. It has significantly streamlined HR operations, reduced payroll discrepancies, and increased transparency between management and employees.",
  ...
  },
  {
    ...
    description: "Prime Hospitals Ltd is a dedicated healthcare mobile application developed for Prime Hospital Ltd in Noakhali, Bangladesh. The platform bridges patients with essential hospital services, allowing quick access to doctor appointments, telemedicine consultations, emergency response helplines, home healthcare services, and comprehensive consultant schedules. Designed to enhance patient convenience and streamline hospital communication, the application provides an intuitive gateway to the hospital's modern multidisciplinary and indoor facilities.",
    fullDetails: [
      "Provides real-time information about Prime Hospital Ltd and its multidisciplinary healthcare facilities.",
      "Enables seamless doctor appointment scheduling and consultant availability tracking.",
      "Offers telemedicine consultation options and direct contact with healthcare professionals.",
      "Provides access to home healthcare services and specialized medical assistance.",
      "Features a one-tap emergency helpline and quick access to 24/7 hospital services.",
      "Showcases information regarding the hospital's 150-bed indoor facilities, diagnostic labs, and modern treatment units."
    ],
    tech: ["Flutter", "Dart", "REST APIs", "Firebase", "HealthTech", "Android"],
    techStack: ["Flutter", "Dart", "REST APIs", "Firebase", "GetX", "shared_preferences"],
    filterCategories: ["flutter", "utilities", "highlights"],
    featured: true,
    installs: "100+",
    rating: "New",
    problem: "Patients and visitors in regional healthcare hubs often face long wait times, difficulty finding accurate consultant schedules, and delays in reaching emergency services or scheduling home healthcare visits.",
    solution: "Developed a responsive cross-platform Flutter application providing centralized access to doctor appointments, telemedicine support, home services, live consultant directories, and instant emergency helplines.",
    outcome: "Successfully published on Google Play Store, serving patients and visitors across Noakhali and surrounding districts with immediate digital access to Prime Hospital's medical departments and services.",
    myRole: "Led the end-to-end mobile development using Flutter and Dart. Designed clean, accessible UI interfaces for scheduling and directory search, integrated REST APIs for real-time doctor availability, and implemented push notifications and quick dialers for emergency support.",
    coreCapabilities: [
      "Doctor Appointment booking and specialist directory",
      "Telemedicine consultation gateway and home medical services",
      "One-tap 24/7 emergency helpline & concern feedback channel",
      "Comprehensive indoor facility, diagnostic lab, and department guides"
    ],
    architecture: [
      "Flutter & Dart for modern cross-platform UI and smooth performance",
      "REST API client integration for real-time consultant schedules & booking data",
      "Firebase Cloud Messaging for appointment reminders and hospital announcements",
      "Modular architecture with state management for robust error handling and quick offline caching"
    ],
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.primehospitalltd.smart",
    imageUrl: "/projects/prime_hospitals_card.png",
    bannerUrl: "/projects/prime_hospitals_banner.png",
  },
  {
    ...
    techStack: ["Flutter", "Dart", "REST APIs", "Firebase", "Camera API", "Live Streaming", "Push Notifications"],
    filterCategories: ["flutter", "commerce", "highlights"],
    featured: true,
    installs: "Recently Launched",
    rating: "5.0★",
    problem: "Aspiring actors and creators often lack dedicated platforms tailored to rehearsing iconic dialogues, receiving constructive peer evaluations, and showcasing their talent directly to a community of like-minded performers.",
    solution: "Built an interactive entertainment and social platform on Flutter featuring an organized scene database, dual-camera video rehearsal/recording, community rating metrics (1-10), live streaming, and rich creator profiles.",
    outcome: "Successfully launched on the iOS App Store with a 5.0★ rating, providing rising artists and film enthusiasts a thriving ecosystem to act, shine, and get discovered.",
    myRole: "Led mobile development using Flutter and Dart. Engineered video capture, front/rear camera switching, live streaming integration, social feeds, user rating workflows, and real-time push notification services.",
    coreCapabilities: [
      "Iconic movie scene recreation with video recording & camera preview",
      "Social creator profiles with follower graphs and portfolio showcase",
      "Community rating system (1-10) with comments, likes, and engagement feeds",
      "Live streaming with real-time audience reactions and instant notifications"
    ],
    architecture: [
      "Flutter & Dart for smooth high-frame-rate media rendering across iOS devices",
      "Custom camera & video encoding pipeline for seamless scene dubbing and playback",
      "Real-time communication channels for live streaming and live comments",
      "Firebase Cloud Messaging & REST APIs for instant notifications and social activity feeds"
    ],
    appStoreUrl: "https://apps.apple.com/us/app/theakktricks/id6777671595",
    imageUrl: "/projects/theakktricks.png",
    bannerUrl: "/projects/theakktricks_banner.png",
  },
  {
    id: "com.hvacassistant.app",
    title: "HVAC Assistant",
    subtitle: "AI Diagnostics & Repair Help",
    description: "HVAC Assistant is an intelligent, AI-powered diagnostic and troubleshooting mobile assistant engineered for HVAC technicians, field service engineers, and homeowners. By harnessing artificial intelligence and an extensive database of major HVAC manufacturers, the app transforms error code lookups and diagnostic workflows into instant, actionable repair steps. Technicians can analyze real-time system metrics, resolve complex multi-brand fault codes, track diagnostic logs by job location, and ensure heating and cooling systems operate at peak efficiency.",
    fullDetails: [
    ...
    techStack: ["Flutter", "Dart", "OpenAI API", "REST APIs", "Firebase", "State Management", "Secure Storage"],
    filterCategories: ["flutter", "ai", "utilities", "highlights"],
    featured: true,
    installs: "Recently Launched",
    rating: "New",
    problem: "HVAC technicians and homeowners frequently face time-consuming diagnostics in the field, navigating hundreds of disparate manufacturer error codes, missing physical manuals, and struggling to calculate airflow or intake temperature thresholds on the spot.",
    solution: "Engineered an AI-assisted troubleshooting companion in Flutter that interprets system symptoms and fault codes in seconds, provides step-by-step resolution guides, and offers live system health monitoring across leading HVAC brands.",
    outcome: "Successfully launched on the iOS App Store, helping technicians reduce diagnostic time on-site, eliminate guesswork in HVAC repairs, and maintain accurate maintenance logs for client installations.",
    myRole: "Architected and developed the complete mobile application using Flutter and Dart. Designed the responsive diagnostic dashboard, implemented the AI chatbot and prompt workflow for HVAC troubleshooting, integrated brand resource libraries, and optimized local caching for field operations.",
    coreCapabilities: [
      "AI-powered HVAC fault-code interpreter & step-by-step repair guidance",
      "Real-time system health tracker (health score, intake temp, airflow status)",
      "Comprehensive brand & model library covering major HVAC manufacturers",
      "Automated diagnostic conversation history organized by job location & date"
    ],
    architecture: [
      "Flutter & Dart for unified, performant iOS user experience in the field",
      "OpenAI API integration for context-aware diagnostic analysis and symptom resolution",
      "State management for real-time sensor metrics and conversational troubleshooting flows",
      "Local secure storage for offline equipment manual caching and job site notes"
    ],
  ...
  },
  {
    ...
    description: "Somtalk is an AI-powered language learning and communication app designed to help users improve their speaking and communication skills through real-time interaction with people around the world. Users can engage with personalized interactive AI speaking companions, join live voice and video practice rooms, make private audio calls, and practice languages in a supportive global community.",
    fullDetails: [
      "Provides live voice rooms for real-time language and speaking practice.",
      "Features interactive AI conversation avatars for natural voice speaking practice and instant feedback.",
    ...
    techStack: ["Flutter", "Dart", "WebRTC", "AI Voice Integration", "Firebase", "REST APIs", "Push Notifications"],
    filterCategories: ["flutter", "ai", "habits", "highlights"],
    featured: true,
    installs: "10+",
    rating: "New",
    problem: "Language learners often experience anxiety when practicing speaking with native speakers and lack affordable, 24/7 conversation partners to build fluency and pronunciation confidence.",
    solution: "Developed an interactive mobile app on Flutter combining AI-driven animated conversational avatars for low-pressure 24/7 speaking practice with real-time peer voice and video rooms.",
    outcome: "Successfully published on Google Play Store, empowering language learners globally with an engaging, interactive platform to build spoken fluency.",
    myRole: "Led mobile architecture and development in Flutter. Implemented real-time audio/voice communication, interactive AI avatar animations, WebRTC calling, and social gamification features.",
    coreCapabilities: [
      "Interactive AI speaking avatar companion with real-time speech responses",
      "Live global voice & video practice rooms with multi-speaker audio",
      "1-on-1 private audio practice calls and instant peer matching",
      "Gamified learning with global leaderboards, rewards, and speech feedback"
    ],
    architecture: [
      "Flutter & Dart for smooth real-time multimedia & UI rendering across devices",
      "Real-time audio streaming and speech recognition integration for conversational AI",
      "WebRTC infrastructure for low-latency live group voice and video rooms",
      "Firebase Cloud Messaging and secure REST API backend for user profiles and leaderboards"
    ],
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.somtalk.app",
    imageUrl: "/projects/somtalk.png",
    bannerUrl: "/projects/somtalk.png",
  },
  {
    id: "com.smartsoftware.apcombd",
    title: "Apcom e-Shop",
    subtitle: "Online Medical Products Shopping",
    description: "Apcom e-Shop is an e-commerce mobile application built for purchasing certified medical equipment, surgical supplies, and healthcare products. The app features structured department categorization, brand catalogs, flash deals, top-selling items, and secure order processing to offer a dependable healthcare procurement channel for clinics, professionals, and patients.",
    fullDetails: [
      "Provides a dedicated e-commerce catalog for certified medical and surgical supplies.",
      "Categorizes products by medical departments, brands, top sellers, and flash deals.",
      "Includes secure user authentication, shopping cart, and order placement workflows.",
      "Features real-time order tracking and promotional notifications.",
      "Designed with a clean, responsive mobile interface optimized for healthcare supplies."
    ],
    tech: ["Flutter", "Dart", "REST APIs", "Firebase", "Push Notifications", "E-Commerce Integration"],
    techStack: ["Flutter", "Dart", "REST APIs", "Firebase", "State Management", "Payment Gateway"],
    filterCategories: ["flutter", "commerce", "highlights"],
    featured: true,
    installs: "10+",
    rating: "New",
    problem: "Procuring specialized medical equipment, diagnostic consumables, and surgical supplies often involves unreliable offline vendors, opaque pricing, and slow ordering processes.",
    solution: "Built a specialized medical e-commerce app with Flutter that streamlines catalog browsing by department and brand, provides transparent pricing with flash deals, and simplifies checkout.",
    outcome: "Successfully deployed on Google Play Store, providing clinics, healthcare providers, and individual buyers a verified digital marketplace for quality medical supplies.",
    myRole: "Led Flutter mobile application development. Engineered the product catalog UI, brand filters, cart management, checkout state flows, REST API synchronization, and push notifications.",
    coreCapabilities: [
      "Department and brand-based medical product catalog browsing",
      "Real-time flash deals, daily discounts, and top sellers showcase",
      "Seamless shopping cart, order placement, and delivery tracking",
      "Customer account management and promotional push notifications"
    ],
    architecture: [
      "Flutter & Dart for smooth, responsive cross-platform e-commerce UI",
      "REST API integration for dynamic product catalog, inventory, and order processing",
      "Firebase Cloud Messaging for transactional and promotional alerts",
      "Modular state management for cart state, product caching, and checkout flows"
    ],
    playStoreUrl: "https://play.google.com/store/apps/details?id=com.smartsoftware.apcombd",
    imageUrl: "/projects/apcom_card.png",
    bannerUrl: "/projects/apcom_banner.png",
  },
];
